  ...
  return (
    <div className="py-18 px-25 dot-cursor min-h-screen">
      <Layout/>
        ...
        <div className="bg-white rounded-3xl shadow-sm overflow-hidden hover:shadow-2xl transition-shadow duration-500 custom-cursor border border-[#cacaca] w-200 h-120">
